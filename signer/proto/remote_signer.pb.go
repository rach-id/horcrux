...
var fileDescriptor_afd7664cd19b584a = []byte{
	...
	0x3b, 0xb5, 0x12, 0xac, 0x96, 0x27, 0x88, 0xad, 0x00, 0xac, 0xc0, 0x68, 0x3e, 0x13, 0x17, 0x4f,
	...
	0xaa, 0x1a, 0x21, 0x65, 0x70, 0x83, 0x13, 0xb9, 0xb8, 0x40, 0xc2, 0x2e, 0x99, 0xe9, 0xa0, 0x20,
	0xc1, 0xad, 0x0f, 0xa2, 0x00, 0x66, 0xbe, 0x26, 0x4e, 0x75, 0xa9, 0x29, 0x30, 0x95, 0x30, 0x2b,
	0x9c, 0x02, 0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09,
	0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0xca, 0x3c, 0x3d, 0xb3,
	0x24, 0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x1f, 0xc9, 0x40, 0xdd, 0xb2, 0xd4, 0xbc, 0x92,
	0xd2, 0xa2, 0xd4, 0x62, 0x78, 0x54, 0x96, 0x19, 0xeb, 0x43, 0xe2, 0x52, 0x1f, 0x1c, 0x97, 0x49,
	0x6c, 0x60, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x07, 0xa4, 0x52, 0x47, 0x36, 0x02, 0x00,
	0x00,
}
...
func (c *remoteSignerClient) SignDigest(ctx context.Context, in *SignDigestRequest, opts ...grpc.CallOption) (*SignedDigestResponse, error) {
	out := new(SignedDigestResponse)
	err := c.cc.Invoke(ctx, "/strangelove.horcrux.RemoteSigner/SignDigest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRemoteSignerServer) SignDigest(ctx context.Context, req *SignDigestRequest) (*SignedDigestResponse, error) {
...
func _RemoteSigner_SignDigest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignDigestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteSignerServer).SignDigest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/strangelove.horcrux.RemoteSigner/SignDigest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteSignerServer).SignDigest(ctx, req.(*SignDigestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RemoteSigner_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RemoteSigner_SignDigest_Handler,
		},
	},
